...
**Network:** Globally Distributed (9 Validators)
...
| **Validators** | 9 (across 2 cloud providers) |
| **Consensus** | Custom Proof-of-Stake |
| **Network Protocol** | libp2p |
| **Cryptography** | Ed25519 (Dilithium3 post-quantum ready) |
...
5. **Post-Quantum Ready** - Architecture designed for Dilithium3 upgrade when needed
...
| **Post-Quantum** | Dilithium3 (planned) | Future upgrade path ready |
...
```
   ...
   │AMS/LON/FRA│        │Singapore│
   └─────────┘          └─────────┘
```

**Validator Distribution:**
- **3 nodes:** Hetzner EU (Nuremberg, Helsinki, Falkenstein)
...
**Total: 9 validators across 2 cloud providers (DigitalOcean + Hetzner)**
...
**Secondary: Dilithium3 (Post-Quantum) — PLANNED**
- Algorithm: CRYSTALS-Dilithium (NIST PQC winner)
- Security level: NIST Level 3 (AES-192 equivalent)
- Quantum-resistant: Yes
- Status: Architecture ready, implementation planned for future upgrade
- Use: Will be used for validator identity keys when activated
...
- [x] 9 global validators operational (2 providers)
...
| Gas Fees | $0 | $0.01 - $50+ |
| Post-Quantum | Dilithium3 (planned) | None |
| Max TPS | 64,000,000 | 10,000 - 65,000 |

**Production Status:** ✅ **LIVE** since December 6, 2025

**Network:** 9 validators across 2 cloud providers
...
| Genesis Supply | 500,000,000 SLTN |
| Inflation | 4% (fixed forever) |
| Transaction Fee | 0 SLTN (zero-fee) |
| Cross-Shard Fee | 0.0001 SLTN |
| Language | Rust |
| Networking | libp2p |
| Storage | RocksDB |
| Cryptography | Ed25519 (Dilithium3 planned) |
| Hashing | SHA3-256 |
...
**Genesis Validators (9 nodes):**

| Region | Provider | Count |
|--------|----------|-------|
| Nuremberg, Germany | Hetzner | 1 |
| Helsinki, Finland | Hetzner | 1 |
| Falkenstein, Germany | Hetzner | 1 |
